            ...
            if let after = afterImage, let before = beforeImage {
                ...
                ZStack {
                    ...
                    VStack {
                        ...
                        // Capture Button
                        Button(action: {
                            // Simulate capturing the "After" shot (using a placeholder for demo)
                            afterImage = PlatformImage.system(name: "house.circle.fill") // Placeholder
                        }) {
                            Circle()
