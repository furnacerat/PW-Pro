...
struct InstantQuoteWidgetView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("This is a preview of the web widget you can embed on your company site. Any quote generated here will automatically create a new LEAD in your client database.")
                    .font(.system(size: 10))
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 12)
                    .stroke(Theme.sky500.opacity(0.2), lineWidth: 1)
            )
            .padding(.horizontal)
            ...
            if !showResult {
                VStack(spacing: 16) {
                    ...
                    LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 8) {
                        ForEach([SurfaceType.sidingVinyl, .concreteStd, .roofShingle, .gutters], id: \.self) { surface in
                            Button {
    ...
    private func calculateQuote() {
        ...
        Task {
            await ClientManager.shared.addClient(newLead)
        }
    }
}
